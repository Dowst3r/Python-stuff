...
window = tk.Tk()
window.title("Bubble Temperature iteration")
...
label_set1_x = tk.Label(window, text="Mole fractions in the liquid phase", bg="white", font="bold")
label_set1_x.pack()
label_set1_x = tk.Label(window, text="x1 value", bg="white")
label_set1_x.pack()
entry_set1_x = tk.Entry(window)
entry_set1_x.pack()
...
label_number = tk.Label(window, text="x2:", bg="white")
label_number.pack()
